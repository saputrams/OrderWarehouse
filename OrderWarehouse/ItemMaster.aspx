<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="ItemMaster.aspx.cs" Inherits="OrderWarehouse.ItemMaster" %>
		...
		<div class="col-12">
			<asp:GridView ID="gvItem" runat="server" AutoGenerateColumns="false" CssClass="table table-hover"
                ...
                <Columns>
                    ...
                    <asp:BoundField ControlStyle-CssClass="w-25" DataField="Qty" HeaderText="Qty" />
